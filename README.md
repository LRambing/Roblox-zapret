...
Все после выполнения этих действий у вас должен работать роблокс без этой 
...
!!! Если у вас был открыт запрет во время изменения в текстовом файле, перезапустите его