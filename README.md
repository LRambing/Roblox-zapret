...
**UPD:**
С **июня 2026 года** роблокс стал еще медленнее работать.
Я добавил новые адреса. Также `service.bat` чуть изменился.

_(необходимые параметры выделены на скриншоте)_ (Кроме IPSet Filter - `loaded`. Должно быть `any`


_________________________________________________________________________________________________________________


<img width="541" height="376" alt="Снимок экрана 2026-06-06 182220" src="https://github.com/user-attachments/assets/eb6602e6-2c31-41ba-86d1-19c1abadb41b" />
